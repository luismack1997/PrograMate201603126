#solución problema por Luis E. Mack 201603126
#Todos los derechos reservados

#Lo primero que hay que hacer es cargar el texto en una variable nueva llamada fichero
import os
ubicacionarchivo=os.path.dirname( os.path.realpath(__file__) )+"\\"+"Ejercicio89.txt"
...
# número romano que podamos, de esta cuenta usaremos el mínimo número de letras
    while digito>0:
#empezamos viendo si el valor es mayor a la letra más grande posible
        if digito>=1000:
#si lo es entonces queremos restarle al dígito dicho valor ya que hemos agregado un número romano.
            digito-=1000
#finalmente a mi nueva cadena (la que tiene la menor cantidad de letras) le agregamos 1 porque hemos agregado una letra
            longitudnueva+=1
        elif digito>=900:
            digito-=900
            longitudnueva+=2
            ...
            digito-=1
            longitudnueva+=1  
#devolvemos el tamaño de lo que hemos ahorrado
